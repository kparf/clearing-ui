...
export const PROVIDER_RESERVATION_DETAILS_COMMENT_CHANGE = 'PROVIDER_RESERVATION_DETAILS_COMMENT_CHANGE';


export function providerReservationDetailsCancelCommentChange(open, value) {
    return {
        type: PROVIDER_RESERVATION_DETAILS_COMMENT_CHANGE,
        open,
        value
    }
}
